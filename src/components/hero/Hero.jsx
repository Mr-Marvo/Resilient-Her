...
const Hero = () => {
  return (
    <div className=' flex flex-col w-full h-[100%] flex-wrap relative hero justify-center items-center'>
        <div className=' flex flex-row  w-full  h-[100vh]  container mx-auto justify-center items-center'>
            <div className=' flex flex-col w-1/3 flex-wrap'>
                ...
                <button className=' border-[1px] border-white text-xl text-white w-[40%] font-bold mt-10 font-chakra py-4 btn-main relative z-1'>Buy a Lady Llama</button>
            </div>
