...
window.addEventListener('touchend', e => {
  ...
  return (
    <div className=' flex flex-col w-full h-auto flex-wrap relative hero justify-center items-center z-40'>
       <canvas className=' w-full h-full  absolute z-30' ref={ref}>
    
        </canvas>
        <Navbar/>
        <div className=' flex flex-row  w-full  h-full  container mx-auto justify-center items-center z-40'>
            ...
            <div className=' flex flex-col w-2/3  justify-center items-center'>
                <img src ={require("../../assets/images/hero.png")} className='w-[130%]   bottom-3 bg-cover h-auto  ' alt="hero"/>
            </div>
        </div>
    </div>
  )
