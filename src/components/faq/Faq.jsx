...
window.addEventListener('touchend', e => {
  ...
  return (
    <div className=' flex flex-col  w-full  h-[100%] relative  hero  z-0 hero overflow-y-scroll overflow-x-hidden'>
        ...
        <div className=' w-full h-auto flex flex-col pt-16  mb-32'>
            <div className=' flex flex-col w-full h-auto justify-center items-center'>
                <h2 className=' uppercase text-white xxs:text-4xl sm:text-6xl  font-custome z-40'>FAQ</h2>
            </div>
