...
//       }, []);
  ...
  return (
    <div className=' flex flex-col w-full h-auto relative hero'>
        {/* <canvas className=' w-full h-full  absolute z-30' ref={ref}>
    
        </canvas> */}
        <div className=' flex-wrap flex flex-col w-full z-40 h-auto container mx-auto relative ' >
            <div className=' flex flex-col flex-wrap w-full h-auto '>
                <div className='  flex flex-row justify-start mt-20 items-center mx-40  pt-3  border-t-[1px]  border-l-[1px] border-r-[1px] '>
                    <img src={demo}alt='slide' className=' w-[250px] h-[300px]'/>
                    <div className='flex flex-col w-auto h-auto pl-4'>
                        <h3 className=' text-white text-3xl font-bold font-sourceCode'>Laid Back Resilient Her Benefits</h3>
