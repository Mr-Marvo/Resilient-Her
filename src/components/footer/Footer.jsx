...
window.addEventListener('touchend', e => {
  ...
  return (
    <div className='flex flex-col flex-wrap relative  w-full h-auto  justify-center items-center'>
        ...
        <div className='w-full h-auto  container mx-auto pt-10  flex flex-col flex-wrap justify-center items-center'>
            <div className='text-white w-full h-auto flex flex-col  justify-center items-center '>
                ...
                <div className=' flex flex-row '>
                   <input type="email" className='z-40 w-[300px] h-[40px] outline-hidden border-none  rounded-full mr-4 px-4' placeholder='Enter email...'/>
                   <button className=' uppercase border-[1px] px-4 h-[40px] font-sourceCode font-bold text-xl  rounded-3xl z-40'>Join</button>
                </div>
            </div>
            <div className='text-white w-auto relative  -left-14   container   flex flex-row  justify-between items-center '>
                <div className=' flex flex-col  h-auto justify-center items-center' >
                   <a href='/'><img src={require("../../assets/images/logo.png")}alt='logo' className='z-40 w-[300px] h-[200px] bg-cover'/></a>
                </div>
                <div className=' mt-2 justify-center items-center mr-20 z-40'>
                    <p>2022 RESILIENT HER | All rights reserved</p>
               </div>
                <div className=' flex flex-row   justify-center items-center text-3xl z-40 '>
                    <div className=' mx-3 cursor-pointer '>
                        <AiOutlineInstagram className='media'/>
                    </div>
                    <div  className=' mx-3 cursor-pointer z-40'>
