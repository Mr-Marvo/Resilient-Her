        ...
        <nav className=' flex flex-row  w-full h-[99px] mt-6  md:container md:mx-auto  bg-dark_1  justify-between items-center'>
            ...
            <div className={`${expand?"navbar  ":"flex-row   w-4/5   h-auto  justify-between mx-16   items-center xxs:hidden xl:flex"} `}>
                    ...
                    <ul className={`${expand?"flex flex-col items-center":" flex flex-row"}   font-custome font-bold xl:text-sm 2xl:text-base pl-4 ` }>
                        <li className=' cursor-pointer uppercase px-5 py-2  relative z-40'><Link to="/" onClick={()=>{setExpand(!expand)}} >Home</Link></li>
                        <li className=' cursor-pointer uppercase px-5 py-2  relative z-40'><Link to="/about"  onClick={()=>{setExpand(!expand)}}>About us</Link></li>
                        <li className=' cursor-pointer uppercase px-5 py-2  relative z-40'><Link to="/aboutNFT"  onClick={()=>{setExpand(!expand)}}>About the NFT</Link></li>
                        <li className=' cursor-pointer uppercase px-5 py-2  relative z-40'><Link to="/roadmap" onClick={()=>{setExpand(!expand)}} >Roadmap</Link></li>
                        <li className=' cursor-pointer uppercase px-5 py-2  relative z-40'><Link to="/mint" onClick={()=>{setExpand(!expand)}} >Mint</Link></li>
                        <li className=' cursor-pointer uppercase px-5 py-2  relative z-40'><Link to="/ask"  onClick={()=>{setExpand(!expand)}}>FAQ</Link></li>
                        <li className=' cursor-pointer uppercase px-5 py-2  relative z-40'><Link to="/team" onClick={()=>{setExpand(!expand)}} >Team</Link></li>
                    </ul>
