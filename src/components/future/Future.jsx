    ...
    <div className=" flex flex-col   w-full   h-screen   relative hero  z-0 overflow-x-hidden   overflow-y-scroll   ">
      ...
      <div className=" flex flex-wrap flex-col w-full  h-full  items-center  mt-4   ">
        <div className=" flex flex-col  w-full  h-auto justify-center items-center ">
          ...
          <div className=" flex flex-col mx-4  w-full h-full  justify-center items-center mt-10">
            <p className=" xxs:text-sm xs:text-xl text-white   xxs:w-[300px] xs:w-[90%]  xxs:px-1 sm:w-[90%]  font-custome z-40 text-center">
              <strong>The Scars</strong>
              <br />
              <br />
              Women worldwide have been facing gender-based violence,
              discrimination, trafficking, and other social issues plaguing the
              community. Every day women are being killed and raped, physically
              abused, and exploited.
              <br />
              <br />
              Regardless of how progressive a country is, women all around the
              world has faced gender-based violence, drug abuse, and much more
              ...
              severe anxiety, social problems, and financial issues because of
            ...
            <p className=" xxs:text-sm xs:text-xl text-white  xxs:w-[300px] xs:w-[90%] xxs:px-1 sm:w-[90%]   font-custome z-40 text-center mt-10">
              <strong>Glimmer of hope . . .</strong> <br />
              <br />
              ...
              the right to speak freely and the right to be heard, and
              appreciate them for their achievements.
              <br />
              <br />
              Give the women their rights and let them grow and fly to find
              their destiny. Millions of women all around the world are waiting
              for the day to be set free from the cage that society has made for
              them. Desperately they are waiting for the day to see the flashes
              of a better life and a glimmer of hope.
            </p>
            <p className=" xxs:text-sm xs:text-xl text-white  xxs:w-[300px] xs:w-[90%]  xxs:px-1 sm:w-[90%]  font-custome z-40 text-center mt-10">
              <strong>The Future is Female!</strong> <br /> <br />
              ...
              equality and freedom. Together we should work toward the
              advancement of women in society. We can do this by giving people
              the tools and support to create a more inclusive and equitable
              workplace for all women, which we define as an environment where
              ...
              equal to those of men,". Women are not less than a man in any way,
              ...
              <br />
              <br />
              Heaven is what the world will become abuse against women will no
              longer exist.
              <br />
              <br />
              Enter Resilient-Her . . . The purpose: To make this world a better
