...
pointers[j].down = false;
  ...
  return (
    <div className='  w-full h-auto relative flex flex-col  flex-wrap justify-center items-center z-0'>
       <canvas className=' w-full h-full  absolute z-30 opacity-60' ref={ref}>
        ...
        <div className=' flex flex-col flex-wrap w-full h-auto pt-10 container mx-auto justify-center items-center'>
            <div className=' flex flex-col w-full h-auto justify-center items-center'>
                <h2 className=' uppercase text-white text-6xl  font-chakra z-40'>LAID BACK Resilient Her TEAM</h2>
            </div>
            <div className=' w-auto h-auto mt-20 grid grid-cols-4 gap-x-10  gap-y-12  justify-items-center justify-self-center'>
                <TeamMember className="z-40"/>
                <TeamMember className="z-40"/>
                <TeamMember className="z-40"/>
                <TeamMember className="z-40"/>
                <TeamMember className="z-40"/>
