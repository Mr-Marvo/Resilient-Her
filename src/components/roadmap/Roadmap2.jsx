      ...
      <div className=' flex flex-col w-full  h-auto  relative  overflow-x-hidden  overflow-hidden'>
        ...
        <div className='flex flex-col  mx-auto w-full  h-auto  '>
          <div className=' flex flex-col w-full h-auto justify-center items-center mt-20 xxs:mb-0 sm:mb-20'>
            <h2 className=' uppercase text-white xxs:text-xl sm:text-4xl text-center md:text-6xl   font-custome z-40'>Resilient Her ROADMAP</h2>
          </div>
          <div className=' flex xxs:flex-col sm:flex-row w-full relative justify-between  mt-10'>
            <div className=' flex flex-row xxs:w-full sm:w-[48%] h-[300px] relative z-40  justify-center xxs:order-2 sm:order-1 xxs:mt-4 sm:mt-0'>
              <img src={require("../../assets/images/s1r.png")} alt='slide' className=' absolute  xxs:w-[200px] xxs:h-[190px] sm:w-[370px] sm:h-[350px]' />
          ...
          <div className=' flex xxs:flex-col sm:flex-row w-full relative justify-between  xxs:mt-10 sm:mt-36  pb-20'>
            <div className=' flex flex-row xxs:w-full sm:w-[49%] h-[300px]  relative order-2 z-40 justify-center xxs:mt-4 sm:mt-0'>
              <img src={require("../../assets/images/s2r.png")} alt='slide' className=' absolute  xxs:w-[200px] xxs:h-[190px] sm:w-[370px] sm:h-[350px]' />
