        ...
        <div className="flex flex-col  mx-auto w-full  h-auto  ">
          ...
          <div className=" flex xxs:flex-col sm:flex-row w-full relative justify-between  mt-10">
            <div className=" flex flex-row xxs:w-full sm:w-[48%] h-[300px] relative z-40  justify-center xxs:order-2 sm:order-1 xxs:mt-4 sm:mt-0">
              <img
                src={require('../../assets/images/s1r.png')}
                alt="slide"
              ...
              <img
                ...
                alt="slide"
                className=" bg-cover xxs:w-[100px] xxs:h-[130px] sm:w-[150px] sm:h-[200px] right-2  top-44 absolute spring z-40"
              />
            </div>
            <div className=" flex flex-row xxs:w-full sm:w-[48%] h-auto border-t-[2px] border-l-[2px] pl-10 pt-4 xxs:order-1 sm:order-2">
              <div className="flex flex-col w-full h-auto justify-center items-start mt-10 ">
                ...
                <h4 className=" text-white text-[18px] font-custome leading-[1] mt-2 z-40">
                  20% of mint + 20% of all future royalties will be added to the
                  community wallet and used for project growth and expansion
                </h4>
          ...
          <div className=" flex xxs:flex-col sm:flex-row w-full relative justify-between  xxs:mt-10 sm:mt-36  pb-20">
            <div className=" flex flex-row xxs:w-full sm:w-[49%] h-[300px]  relative order-2 z-40 justify-center xxs:mt-4 sm:mt-0">
              <img
                src={require('../../assets/images/s2r.png')}
                alt="slide"
                className=" absolute  xxs:w-[200px] xxs:h-[190px] sm:w-[370px] sm:h-[350px]"
              />
              ...
              <img
                src={require('../../assets/images/down arrow.png')}
                alt="slide"
                className=" bg-cover xxs:w-[100px] z-[999]  xxs:h-[130px] sm:w-[150px] sm:h-[200px] left-2  top-44 absolute spring"
              />
            </div>
            <div className=" flex flex-row xxs:w-full sm:w-[49%] h-auto order-1 border-t-[2px] border-r-[2px]  pr-10 pt-4">
              <div className="flex flex-col w-full h-auto justify-center items-end   ">
                <div className=" flex flex-row w-full  leading-[1]  justify-end items-center">
                  <h2 className=" xxs:text-[60px] sm:text-[100px]  font-mono font-bold text-purple-600 ml-8 order-2 text-end mb-7  z-40">
                    20%
                  </h2>
                ...
                <h4 className=" text-white text-[18px] font-custome  leading-[1] mt-2 text-end z-40">
                  Various clubhouses will be acquired in the meta-verse (Eg
                  Sandbox, decentraland) where our members can debrief and
                  discuss tactics
                </h4>
              </div>
            </div>
