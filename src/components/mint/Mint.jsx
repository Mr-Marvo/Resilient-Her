...
//       }, []);
  return (
    <div className=' w-full h-screen xxs:overflow-y-scroll xxs:overflow-x-hidden lg:overflow-hidden relative flex flex-col hero'>
            ...
            <div className='xxs:p-3 xxs:w-[300px] xxs:h-auto xs:w-[350px] xs:h-auto  sm:w-[500px] sm:h-[400px] flex flex-col  bg-dark_1  rounded-xl px-4 justify-center items-center mint'>
                ...
                <div  className=' w-full h-auto flex flex-row text-white justify-between mt-10 items-center'>
                    ...
                    <div className=' w-full h-auto flex flex-row text-white justify-around items-center z-40'>
                        <div className=' xxs:w-[20px] xxs:h-[20px]  xs:w-[40px] xs:h-[40px]  font-bold cursor-pointer rounded-full bg-red-500 flex justify-center items-center'>
                            <BiMinus/>
                        </div>
                        <strong className=' border-[1px] px-4 py-4 font-custome font-bold'>002</strong>
                        <div className='xxs:w-[20px] xxs:h-[20px]  xs:w-[40px] xs:h-[40px] font-bold cursor-pointer rounded-full  bg-sky-600 flex justify-center items-center'>
                            <AiOutlinePlus/>
                        </div>
                    </div>
                    <strong className='xxs:text-sm sm:text-xl z-40'>0.001ETH</strong>
                ...
                <div  className=' w-full mt-10 h-auto flex flex-row text-white justify-center items-center' >
                    <button className='z-40 uppercase bg-neutral-700 xxs:text-sm sm:text-xl cursor-pointer px-4 py-4'>Mint Now</button>
                </div>
            </div>
        </div>
        <Footer/>
